            ...
            <div class="bs_border_container">
               ...
               <div class="content">
                  <?php
                     ...
                     echo $this->Form->input('title', array('class' => 'form-control parsley-validated', 'placeholder' => 'Enter city name to search', 'label' => array('class' => 'col-sm-2 control-label', 'text' => 'City') ));
               ...
               <table class="table table-bordered" id="datatable2" >
                  <thead>
                     <tr>
                        ...
                        <th><?php echo $this->Paginator->sort('title','City'); ?></th>
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td><?php echo $this->Text->excerpt($city['City']['title'], 'method', 100, ''); ?>
                        </td>
