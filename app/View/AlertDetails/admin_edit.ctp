...
<?php pr($this->validationErrors); echo $this->Form->create('AlertDetail'); ?>
	<fieldset>
		<legend><?php echo __('Edit Alert Detail'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('AlertDetail.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('AlertDetail.id'))); ?></li>
