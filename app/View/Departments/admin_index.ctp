...
<div class="page-head">
   <ol class="breadcrumb">
      <li class="active"><i class="fa fa-plus-square"></i>&nbsp;<?php echo $this->Html->link(__('New Department'), array('action' => 'add')); ?></li>
   </ol>
</div>
<div class="block block-color primary">
   ...
   <div class="content">
      ...
      <div class="row">&nbsp;</div>
      <?php echo $this->Form->create('Department', array('action' => 'bulk_action/','onsubmit'=>'return confirm("Are you sure, you want to perform the bulk actions?");')); ?>
               ...
               <table class="table table-bordered" id="datatable2" >
                  <thead>
                     <tr>
                        ...
                        <th><?php echo $this->Paginator->sort('title','Department'); ?></th>
                  ...
                  <tbody>
                     ...
                     <tr>
                        <td><?php echo $this->Form->checkbox('del_item.', array('class' => 'del_item', 'hiddenField' => false, 'value' => $department['Department']['id'] ) ); ?></td>
                        <td><?php echo h($department['Department']['id']) ?></td>
                        <td><?php echo $this->Text->excerpt($department['Department']['title'], 'method', 80, ''); ?>
                        </td>
                        <td><?php echo $this->Html->link($department['City']['title'], array('controller' => 'cities', 'action' => 'view', $department['City']['id'])); ?></td>
                        <td align="center"><?php echo $this->Html->link($this->Html->image('icon_' . $department['Department']['status'] . '.png'), array('controller' => 'departments', 'action' => 'switch', 'status', $department['Department']['id']), array('class' => 'status', 'escape' => false)); ?></td>
                        ...
                        <td>
                           <div class="btn-group">
                              ...
                              <ul role="menu" class="dropdown-menu">
                                 ...
                                 <li><?php echo $this->Html->link(__('Details'), array('action' => 'view', $department['Department']['id'])); ?></li>
                                 <li class="divider"></li>
                                 <li>
                                    <?php
                  ...
                  <div class="col-sm-12">
                     ...
                     <div class="pull-right">
                        <div class="dataTables_paginate paging_bs_normal" id="datatable2_paginate">
                           <?php if( $this->Paginator->params['paging']['Department']['pageCount'] > 1 ){ ?>
                           <ul class="pagination">
                              <?php
