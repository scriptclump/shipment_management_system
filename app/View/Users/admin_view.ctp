...
<div class="content">
    <div class="table-responsive">
    	<table class="table-bordered table-striped">
            <tbody>
                <tr>
                	<td width="25%" valign="top"><strong><?php echo __('Cassillero #'); ?></strong></td>
                ...
                <tr>
                    ...
                    <td width="75%" valign="top"><?php echo h($city['City']['title']); ?></td>
                </tr>
                 <tr>
                    <td width="25%" valign="top"><strong><?php echo __('Department'); ?></strong></td>
                    <td width="75%" valign="top"><?php echo h($department['Department']['title']); ?></td>
                </tr>
                <tr>
