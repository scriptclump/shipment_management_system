               ...
               <table class="table table-bordered" id="datatable2" >
                  <thead>
                     <tr>
                        ...
                        <th><?php echo $this->Paginator->sort('id', __('Cassillero')); ?></th>
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td><?php echo __('Cassillero # '). h($user['User']['id']) ?></td>
                        <td><?php echo h($user['Profile']['fname']); ?>&nbsp;<?php echo h($user['Profile']['lname']); ?>
                        </td>
